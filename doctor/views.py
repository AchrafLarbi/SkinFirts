...
from .serializers import SpecializationSerializer, DoctorSerializer, ReviewSerializer, FavoriteDoctorSerializer, FavoriteDoctorListSerializer
...
class TopRatedDoctorsView(APIView):
    def get(self, request):
        ...
        serializer = DoctorSerializer(top_doctors, many=True)
