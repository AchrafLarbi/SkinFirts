...
class DoctorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Doctor
        fields = ['id','name','lastname', 'profile_picture', 'degree', 'specialization', 'experience_years', 'rating', 'reviews_count', 'available_days', 'available_hours', 'bio', 'career_path', 'highlights']
